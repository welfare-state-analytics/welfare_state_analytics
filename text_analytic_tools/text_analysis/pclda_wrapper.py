...
# -*- coding: utf-8 -*-
#
# This file is based on Gensim's LdaWrapper
#
# Copyright (C) 2014 Radim Rehurek <radimrehurek@seznam.cz>
# Licensed under the GNU LGPL v2.1 - http://www.gnu.org/licenses/lgpl.html


r"""Python wrapper for `Partially Collapsed LDA <https://github.com/lejon/PartiallyCollapsedLDA>`_
...
Installation
------------
Follow instructions in `<https://github.com/lejon/PartiallyCollapsedLDA>`_ or this one ::

    Install java and maven using installer or download binaries, unpack and install:
    ...
    Clone repository:
      git clone https://github.com/lejon/PartiallyCollapsedLDA.git
    Compile:
      cd PartiallyCollapsedLDA/
...
.. sourcecode:: pycon
    ...
    >>>
    >>> path_to_pclda_binary = "/path/to/pclda/binary"
    >>> model = LdaPCLDA(path_to_pclda_binary, corpus=common_corpus, num_topics=20, id2word=common_dictionary)
...
class PCLDAWrapper(utils.SaveLoad, basemodel.BaseTopicModel):
    """Python wrapper for LDA using `PC-LDA <https://github.com/lejon/PartiallyCollapsedLDA/>`_.

    Communication between PC-LDA and Python takes place using jpype.
