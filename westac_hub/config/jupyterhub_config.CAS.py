...
c.DockerSpawner.network_name = os.environ['DOCKER_NETWORK_NAME'] # See https://github.com/jupyterhub/dockerspawner/blob/master/examples/oauth/jupyterhub_config.py
...
# c.CASAuthenticator.cas_login_url = 'https://cas.test.umu.se/login'
# c.CASLocalAuthenticator.cas_logout_url = 'https://cas.test.umu.se/login'
# # The CAS endpoint for validating service tickets.
# c.CASAuthenticator.cas_service_validate_url = 'https://cas.test.umu.se/serviceValidate'
...
# c.Authenticator.admin_users = { 'roger' }

# Github:
from oauthenticator.github import GitHubOAuthenticator
c.JupyterHub.authenticator_class = GitHubOAuthenticator

# c.Authenticator.whitelist =  {'roger', 'fredrik_noren'}
# c.Authenticator.admin_users = { 'roger' }
