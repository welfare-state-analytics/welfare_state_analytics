...
def run_model(
    ...
    if corpus_type == "vectorized":
        ...
        v_corpus = vectorized_corpus.VectorizedCorpus.load(corpus_name, data_folder)
    ...
    m_data, c_data = topic_modelling.compute.compute_model(
        terms=None,
        doc_term_matrix=dtm,
        id2word=id2token,
        documents=documents,
    ...
    topic_modelling.store_model(m_data, jj(data_folder, name))
