...
SPEECH_INDEX: pd.DataFrame = load_speech_index('/data/westac/shared/document_index.csv.xz', '/data/westac/shared/members.json')
...
class CaseOneGUI:
    ...
    kind = Dropdown(description='Kind', options=['area', 'line', 'bar', 'table'], value='area', layout={'width': '150px'})
